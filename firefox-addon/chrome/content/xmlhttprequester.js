function CloudMagic_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
CloudMagic_xmlhttpRequester.prototype.contentStartRequest = function(details) {
    ...
    switch (scheme) {
        ...
        case "ftp":
            this.chromeWindow.setTimeout(
                mailbrowser_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
            break;
        default:
...
CloudMagic_xmlhttpRequester.prototype.chromeStartRequest=function(safeUrl, details) {
...
CloudMagic_xmlhttpRequester.prototype.setupRequestEvent =
    ...
    if (details[event]) {
        req[event] = function() {
            var responseState = {
                ...
                responseHeaders:(req.readyState == 4 && event != "onerror" ? req.getAllResponseHeaders() :""),
                status:(req.readyState==4?req.status:0),
                statusText:(req.readyState == 4 && event != "onerror" ? req.statusText : ""),
            }
